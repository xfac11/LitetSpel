...
bool Slider::render(bool selected)
{
	...
	System::getSpriteBatch()->Draw(Slider::slider.getTexture(), DirectX::SimpleMath::Rectangle(static_cast<long>(this->position.x + 5), static_cast<long>(this->position.y + 5), static_cast<long>((this->value / static_cast<float>(this->maxValue)) * 600), 25L), DirectX::Colors::White);
