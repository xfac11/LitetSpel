...
bool LooserView::render(bool selected)
{
	...
	System::getFontArial()->DrawString(System::getSpriteBatch(), ("Damage: " + std::to_string(stats.damage)).c_str(), this->position + SimpleMath::Vector2(30.0F, 340.0F + 80.0F), Colors::Black, 0, SimpleMath::Vector2::Zero, SimpleMath::Vector2::One * 0.5F);
