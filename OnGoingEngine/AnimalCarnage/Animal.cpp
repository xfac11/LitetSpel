...
AnimalDef Animal::rabbit = { 75,		0.5F,	1.0F,	1.0F,		10,			"Resources/Models/rabbit_character", "fox_character_mask.tga", rabbitV};
AnimalDef Animal::moose =  { 175,		2.0F,	0.6F,	0.8F,		12,			"Resources/Models/rabbit_character", "fox_character_mask.tga",rabbitV };
